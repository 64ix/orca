...
const UiUpdateFields = z
  .object({
    ...
    groupBy: z.enum(['none', 'workspace-status', 'repo', 'pr-status', 'workflow-stage']).optional(),
    ...
    featureBoardGhostDismissals: z
      ...
      .optional(),
    featureBoardCollapsedGhostStages: z.array(z.enum(WORKFLOW_STAGE_IDS)).optional(),
    featureBoardProjectSelection: StringArray.nullable().optional(),
