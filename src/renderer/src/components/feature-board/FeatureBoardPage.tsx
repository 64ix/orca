 ...
 * search/filters (#50), and ghost cards (#49) are separate tickets — see the extension points
 * documented on `FeatureBoardColumn`/`FeatureBoardColumnHeader` and `buildFeatureBoardColumns`.
 */
export default function FeatureBoardPage(): React.JSX.Element {
  ...
  const columns = useFeatureBoardColumns(selection.selected, selection.selectedProjectKeys)
